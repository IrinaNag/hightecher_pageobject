...
public class LoginTest extends TestBase {
    ...
    @Test(dataProvider = "loginWithoutCreds", dataProviderClass = GuiDataProvider.class)
    public void testLoginWithoutCreds(UserCredsGui userCreds) {
        List<String> errors = loginPage.fillLoginForm(userCreds).getListOfErrors();
        int errorsNumber = 0;
    ...
    @Test(dataProvider = "loginWithWrongEmail", dataProviderClass = GuiDataProvider.class)
    public void testLoginWithWrongEmail(UserCredsGui userCreds) {
        List<String> errors = loginPage.fillLoginForm(userCreds).getListOfErrors();
    ...
    public void testLoginWithWrongPassword() {
        loginPage.fillLoginForm(UserCredsGui.builder().email("a@a").password("1").build());
    ...
    @Test(dataProvider = "loginWithPositiveData", dataProviderClass = GuiDataProvider.class)
    public void testLoginWithValidCreds(UserCredsGui userCreds) {
        List<String> errors = loginPage.fillLoginForm(userCreds).getListOfErrors();
